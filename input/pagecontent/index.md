![image](https://github.com/mimohuss/mh-smart-immunizations-measles/assets/148956082/6e4297e6-105a-4753-9540-0a0f42530d2a)


This MH Immunization Implementation Guide details how to use Health Level 7 (HL7) Fast Healthcare Interoperability Resources (FHIR) for consistent digital representation of immunization services.
...
### Summary 
This implementation guide includes a machine-readable representation of MH guidelines for immunization, as documented in the WHO Digital Adaptation Kit: SMART Guidelines for Immunizations (link forthcoming) and explicitly encodes computer-interoperable logic, including data models, terminologies, and logic expressions, in a computable language to support implementation of immunization use cases by WHO Member States.
